...
import KeyMetric from "@/climatemapped-africa/components/HURUmap/KeyMetric";
import SubcategoryHeader from "@/climatemapped-africa/components/HURUmap/SubcategoryHeader";
import Loading from "@/climatemapped-africa/components/Loading";
import formatNumericalValue from "@/climatemapped-africa/utils/formatNumericalValue";
import slugify from "@/climatemapped-africa/utils/slugify";

const Chart = dynamic(
  () => import("@/climatemapped-africa/components/HURUmap/Chart"),
  {
    ssr: false,
    loading: () => <Loading />,
  },
