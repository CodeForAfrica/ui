  ...
  hooks: {
    afterRead: [
      ({ doc }) => ({
        ...
        alt: doc.alt ?? null,
        /*
        Since we are setting ENV PAYLOAD_PUBLIC_APP_URL=http://localhost:3000 at build time, generating static pages(404,500) ends up with image urls with `http://localhost:3000/media/cfalogobw.svg`.
