...
import TwoToneBackground from "@/civicsignalblog/components/TwoToneBackground";
...
const NextPreviousPagination = React.forwardRef(
  function NextPreviousPagination(props, ref) {
